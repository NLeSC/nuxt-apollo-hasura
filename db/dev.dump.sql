...
--
-- Name: yet; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.yet (
    id integer NOT NULL
);


ALTER TABLE public.yet OWNER TO postgres;

--
-- Name: yet_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.yet_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.yet_id_seq OWNER TO postgres;

--
-- Name: yet_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.yet_id_seq OWNED BY public.yet.id;
...
--
-- Name: yet id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.yet ALTER COLUMN id SET DEFAULT nextval('public.yet_id_seq'::regclass);
...
public	yet	public	select	{"filter": {}, "columns": [], "computed_fields": [], "allow_aggregations": false}	\N	f
\.
...
df610aef-4840-4be7-9b4e-90a0f3e735f5	2020-07-25 21:02:37.364215+00	{"metadata":false,"remote_schemas":[]}
\.
...
public	yet	{"custom_root_fields": {}, "custom_column_names": {}}	f	f
\.
...
42503795-2178-4703-9cf5-c6000eb9e0e8	36	2020-07-25 21:00:37.518958+00	{}	{"telemetryNotificationShown": true}
\.
...
COPY public.roles (value, comment) FROM stdin;
admin	Super admin
user	Logged user
\.
...
COPY public.users (id, name, last_name, email, created_at, updated_at, role) FROM stdin;
\.
...
--
-- Name: yet yet_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.yet
    ADD CONSTRAINT yet_pkey PRIMARY KEY (id);

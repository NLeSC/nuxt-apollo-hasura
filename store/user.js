...
export const actions = {
  UPSERT_USER({ commit }, all) {
    ...
    if (!all.authUser) {
      ...
      const user = {
        uid: all.claims.user_id,
        email: all.claims.email,
        emailVerified: all.claims.emailVerified,
        name: all.claims.name,
        picture: all.claims.picture,
      }
